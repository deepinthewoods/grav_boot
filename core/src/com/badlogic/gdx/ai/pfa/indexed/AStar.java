...
public class AStar<N> implements PathFinder<N> {
	...
	public static final int PATHFINDING_INITIAL_Y_OFFSET = 5, PATHFINDING_DOWN_Y_OFFSET = 1, PATHFINDING_UP_Y_OFFSET = 10
			, PATHFINDING_X_START = 15, PATHFINDING_WIDTH = 20;
	...
	public static final int PATHFINDING_WALL_HEIGHT = 10;
	...
	public AStar (IndexedGraph<N> graph, boolean calculateMetrics) {
		this.graph = graph;
