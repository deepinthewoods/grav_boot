 ...
 * @author Nathan Sweet */
public class CheckBoxNiz extends TextButton {
	private Image image;
	private Cell imageCell;
	private CheckBoxStyle style;

	public CheckBoxNiz (String text, Skin skin) {
		this(text, skin.get(CheckBoxStyle.class));
	}

	public CheckBoxNiz (String text, Skin skin, String styleName) {
		this(text, skin.get(styleName, CheckBoxStyle.class));
	}

	public CheckBoxNiz (String text, CheckBoxStyle style) {
		super(text, style);
		clearChildren();
	...
	/** The style for a select box, see {@link CheckBoxNiz}.
	 * @author Nathan Sweet */
