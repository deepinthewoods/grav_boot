...
public class Race implements Component, Poolable {
	...
	public static final int HUMAN = 0, RED_DRAGON = 1, GREEN_DRAGON = 2, WHITE_DRAGON = 3, NONE = 4, WOLF = 5, STRUGIO = 6, RAPTOR = 7;
	...
	public static final int TOTAL_RACES = 8;
	public static final int PHYSICS_NOrMAL = 0, PHYSICS_RUNNER = 1;
	public static final String[] raceNames = {"Human", "Red Dragon", "Green Dragon", "White Dragon", "RPG", "none", "rpg1", "rpg2"}
