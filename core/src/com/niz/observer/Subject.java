...
public class Subject {
	...
	public enum Event {TEST, POSITION_CHANGE, BUTTON_IS_PRESSED, SLIDER_PRESSED, 
		...
		PAPERDOLL, WORLD_DEFINITION_SET, ROOM_DEFINITION_CHANGE, ROOM_BORDER_CHANGE, ROOM_PATCH_CHANGE, DRAG_BLOCK, DRAG_SCREEN, OK_BUTTON, OK_BUTTON_ENABLE
		, OK_BUTTON_DISABLE, SAVE_ROOM, ON_DOOR
		, HEALTH_CHANGE, CHANGE_SELECTED_CHARACTER, CHANGE_LEVEL
		};
