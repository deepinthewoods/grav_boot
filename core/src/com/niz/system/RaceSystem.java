...
public class RaceSystem extends EntitySystem implements Observer, EntityListener {
	...
	public void entityAdded(Entity e) {
		...
		String[] racePrefixes = {"player", "reddragon", "greendragon", "whitedragon", "none", "wolf", "strugio", "raptor"};
		String[] guidePrefixes = {"player", "dragon", "dragon", "dragon", "none", "wolf",             "strugio", "raptor"};
        ...
        for (int i = 0; i < racePrefixes.length; i++){
        	//if (racePrefixes[i].contains("rpg")) Gdx.app.log(TAG, "race " + Data.hash(racePrefixes[i] + "torso") + racePrefixes[i]);
		...
		i++;
			...
			anim.torso = i;
			//Gdx.app.log(TAG, "raceid " + race.raceID[Race.TORSO]);
		...
		break;
		default:
		case Race.RED_DRAGON:case Race.GREEN_DRAGON:case Race.WHITE_DRAGON:
